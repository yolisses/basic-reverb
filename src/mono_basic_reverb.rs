...
pub struct MonoBasicReverb<const CHANNELS: usize, const SAMPLE_RATE: u32> {
    basic_reverb: BasicReverb<CHANNELS, SAMPLE_RATE>,
}

impl<const CHANNELS: usize, const SAMPLE_RATE: u32> MonoBasicReverb<CHANNELS, SAMPLE_RATE> {
